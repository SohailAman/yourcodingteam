...
const translations = {
    'en': {
        ...
        'btn-1': 'See More',
        'para-2': 'The salary for software developers in our offshore locations ranges on average between €900 and €2200 gross per month, depending on expertise and experience. The employee receives the agreed amount per month from Yourcodingteam. In case of illness or absence, the developer will be paid according to their contract conditions. This is not passed on to you as a company, which minimizes your risk. With Yourcodingteam, the client only pays for the hours worked.',
        'btn-2': 'Get In Touch',
        ...
        'para-4': "We assure complete confidentiality for all client data, and our firm and team members commit to not disclosing any information pertaining to the project without obtaining explicit consent from the client. We are happy to sign a non-disclosure agreement (NDA) at the client's request.",
    ...
    'nl': {
        ...
        'para-4': 'Wij waarborgen de vertrouwelijkheid van alle gegevens die door de klant worden verstrekt. Ons bedrijf en personeel garanderen dat geen enkele informatie over het project zonder toestemming van de klant aan derden zal worden verstrekt. Wij zijn meer dan bereid om op verzoek van de klant een niet-openbaarmakingsverklaring (NDA) te ondertekenen.',
