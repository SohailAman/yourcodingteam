...
const translations = {
    'en': {
        ...
        'para-4': "We assure complete confidentiality for all client data, and our firm and team members commit to not disclosing any information pertaining to the project without obtaining explicit consent from the client. We are ready to sign a non-disclosure agreement (NDA) at the client's request.",
